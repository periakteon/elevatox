...
export interface EditBuildingResponsiblePerson {
  phone: string;
  address: string;
  city: string;
  district: string;
...
interface DataTableProps<TData extends EditBuildingResponsiblePerson, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
}

export function DataTable<TData extends EditBuildingResponsiblePerson, TValue>({
  columns,
  data,
