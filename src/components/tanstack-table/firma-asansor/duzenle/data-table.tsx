...
import { type ElevatorType } from "@prisma/client";

export interface UpdateElevatorTableParams {
...
interface DataTableProps<TData extends UpdateElevatorTableParams, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
}

export function DataTable<TData extends UpdateElevatorTableParams, TValue>({
  columns,
  data,
          ...
          <div className="flex items-center">
            ...
            >
              <SelectTrigger className="mr-2 w-full">
                <SelectValue placeholder="Bina Adı" />
              </SelectTrigger>
              <SelectContent>
                ...
                <SelectItem value="elevatorType">Tip</SelectItem>
              </SelectContent>
            </Select>
            <Input
              placeholder={`${
