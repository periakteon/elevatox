...
export interface DeleteElevatorTable {
...
interface DataTableProps<TData extends DeleteElevatorTable, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
}

export function DataTable<TData extends DeleteElevatorTable, TValue>({
  columns,
  data,
