...
const AdminAddUserIndex: MyPage = () => {
            ...
            <code
              ...
              onClick={() =>
                void copyToClipboard(
                  `http://localhost:3000/firma/kayit?id=${createCompany.data.token}`,
                )
              }
            >
              {`http://localhost:3000/firma/kayit?id=${createCompany.data.token}`}
...
export default AdminAddUserIndex;
AdminAddUserIndex.Layout = "Admin";
