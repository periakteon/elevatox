...
const EditMaintenance: MyPage = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Bakım Kaydı Düzenle | {companyInfo?.companyInfo.name} - ElevatoX
        </title>
      </Head>
      <div className="p-4 sm:ml-64">
        <Card className="mt-16 rounded-lg p-0">
          <CardHeader>
            <CardTitle>Bakım Kaydı Düzenle</CardTitle>
            <CardDescription>
              ...
              <span className="block">
                ...
                kaydı düzenlemek için öncelikle bakım listesine gitmeniz
                gerekmektedir.
              </span>
            </CardDescription>
          </CardHeader>
